...
MODEL_NAME     = UseFmu_Seperator
DEFINES_OTHER  = -DMODEL=UseFmu_Seperator -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DRT -DUSE_RTMODEL

#------------------------ model referencing ----------------------------------
MODELREFS                 = 
MODELLIB                  = 
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = UseFmu_Seperator_ref.rsp
