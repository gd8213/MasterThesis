...
MODEL_NAME     = FMU_Seperator
DEFINES_OTHER  = -DMODEL=FMU_Seperator -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DRT -DUSE_RTMODEL

#------------------------ model referencing ----------------------------------
MODELREFS                 = 
MODELLIB                  = 
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = FMU_Seperator_ref.rsp
